...
!!! warning "Operação Preferencial de Pista"
    ...
    Em condições meteorológicas com {==**componente de vento de cauda menor ou igual a 7KT**==}, a configuração preferencial de pista de pouso e decolagem será a utilização das RWY 15 e RWY 10, respectivamente. Tal configuração será normalmente utilizada em preferência à utilização das RWY 28 e RWY 33, desde que a superfície da pista **esteja seca**.
    
    Quando o sistema de pista de pouso e decolagem em uso for RWY 15 e RWY 10 com componente de vento de cauda, os pilotos que solicitarem autorização para utilizar o sistema RWY 28 e RWY 33 devem considerar que seu pouso ou decolagem {==**pode sofrer atraso**==}.

!!! warning "Operação de Pista Única"
...
- TWY `B` entre `F` e `G` exclusiva para ACFT com no máximo 36m de envergadura.
???+ warning "Atenção!"
...
- Devido inexistência de área para cheque de motores, será utilizado, em casos excepcionais, trecho da TWY `M` entre a TWY `S` e TWY `V`.
