...
As colunas "Exijo autorização ATC" e "Exijo radiocomunicação" reproduzem as duas últimas colunas do Anexo II da ICA 100-37, condensando as linhas IFR e VFR de cada classe em uma só. Onde as duas linhas divergem — em radiocomunicação nas Classes E, F e G, e em autorização ATC apenas na Classe E —, a divergência está explicitada na célula. Ver as notas de leitura do [capítulo de Classes de Espaço Aéreo](02-classes.pt.md#tabela-consolidada-anexo-ii-da-ica-100-37), em especial a que trata da linha **D / VFR**.
