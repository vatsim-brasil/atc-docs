...
De acordo com as recomendações da ICAO, na definição das palavras e expressões da fraseologia, foram adotados os seguintes princípios:
...
3. na fraseologia inglesa, utilizam-se, preferencialmente, palavras de origem latina.

### O que se deve evitar

Não devem ser utilizadas palavras que:

1. em virtude de sua semelhança fonética, possam gerar confusão no entendimento. 

!!! info "Exemplos"
    Aguardar com decolar, hold com roll, afirmativo com negativo.

2. sejam vazias de significado.
!!! info "Exemplos"
    Ok, ah, eé...
